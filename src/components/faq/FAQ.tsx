  ...
  const items = [
    {
      ...
      content:
        'Так, повернення білет доступно не пізніше ніж за 24 години до початку події.',
    },
    {
    ...
    {
      title: 'Як я можу вивести гроші від продажу квитків?',
      content:
        'Всі отримані кошти від білетів ви отримуєте на рахунок аккаунта, які можна вивести на будь-яку банківську карту.',
    },
  ];
